...
웨이트트레이닝이나 크로스핏의 일반적인 근력·심폐 동작을 제외하고, 집에서 가볍게 수행할 수 있는 기능 움직임 66가지를 정리한 개인용 메뉴판입니다.
...
- 출력용 6페이지 PDF: `output/pdf/functional_movement_menu.pdf`
...
`.github/workflows/daily-telegram-routine.yml`이 매일 한국 시각 낮 12시에 실행됩니다. 66개 동작 풀에서 다섯 영역별로 한 동작씩 골라 약 10분 분량의 루틴을 만들고, 동작 그림과 권장량을 Telegram 앨범으로 전송합니다.
